...
//NSString *const SDLAppName = @"DiagnosticTool";
...
///    SDLAppHMIType.SYSTEM,
    ...
    lifecycleConfig.appType =  SDLAppHMIType.INFORMATION;
...
- (void)startTCP {
    ...
    [center addObserver:self selector:@selector(change:) name:SDLTransportDidConnect object:nil];
    [center addObserver:self selector:@selector(change:) name:SDLDidReceiveLockScreenIcon object:nil];
    [center addObserver:self selector:@selector(change:) name:SDLDidChangeHMIStatusNotification object:nil];
