...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
   ...
   // [[ProxyManager sharedManager] startTCP];
    ...
    self.routineRunTime = [userDefaults integerForKey:KRoutineRunTime];
    if (self.routineRunTime == 0) {
        self.routineRunTime = 5;
        [userDefaults setInteger:5 forKey:KRoutineRunTime];
